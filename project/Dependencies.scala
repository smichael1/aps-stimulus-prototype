...
//  val sprayJsonShapeless = "com.github.fommil" %% "spray-json-shapeless" % "1.2.0" // ApacheV2
  ...
  val cs = "org.tmt" % "cs_2.11" % "0.3-SNAPSHOT" 
  val ccs = "org.tmt" % "ccs_2.11" % "0.3-SNAPSHOT" 
  val loc = "org.tmt" % "loc_2.11" % "0.3-SNAPSHOT" 
  val ts = "org.tmt" % "ts_2.11" % "0.3-SNAPSHOT" 
  val events = "org.tmt" % "events_2.11" % "0.3-SNAPSHOT" 
  val util = "org.tmt" % "util_2.11" % "0.3-SNAPSHOT" 
  val alarms = "org.tmt" % "alarms_2.11" % "0.3-SNAPSHOT" 
  val containerCmd = "org.tmt" % "containercmd_2.11" % "0.3-SNAPSHOT" 
